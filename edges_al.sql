WITH user_friends AS (
		...
		WHERE fu1.nu=1 AND fu2.nu=1 AND (uid1 = 100000862956701 OR uid2 = 100000862956701)
     ),
...
LEFT OUTER JOIN facebook_users fu1 ON ff.uid1=fu1.uid
LEFT OUTER JOIN facebook_users fu2 ON ff.uid2=fu2.uid
WHERE fu1.nu=1 AND fu2.nu=1 AND (uid1 IN (SELECT uid FROM user_distinct_friends) AND uid2 IN (SELECT uid FROM user_distinct_friends)) AND uid1!=100000862956701 AND uid2!=100000862956701;